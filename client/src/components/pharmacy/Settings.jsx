...
function Settings() {
  const { user } = useAuth();
  const { openTime, updateInfo, updateOpeningTime } =
    usePharmacy();
  ...
  return (
    <div>
      <PageTitle title="แก้ไขข้อมูล" toPage="/pharmacy" />
      ...
      <Box component='form' mt="10px" onSubmit={handleSubmit}>
        <Grid container spacing={1}>
          ...
          <Grid item xs={6}>
            <label htmlFor="dayStart">ตั้งแต่</label>
            <select
              className="select"
              id="dayStart"
              value={dayStart}
          ...
          <Grid item xs={6}>
            <label htmlFor="dayEnd">ถึง</label>
            <select
              className="select"
              id="dayEnd"
          ...
          <Grid item xs={3}>
            <label htmlFor="timeStartH">เวลาเปิด</label>
            <input
          ...
          <Grid item xs={2}>
            <label htmlFor="timeEndM">นาที</label>
            <input
              className="form-input time"
          ...
          <Grid item xs={3}>
            <label htmlFor="timeEndH">เวลาปิด</label>
            <input
              className="form-input time"
              value={timeEndHour}
              id="timeEndH"
        ...
        <Paper sx={{ p: 1, my: 1 }}>
          ...
          <Typography>เลือกในแผนที่</Typography>
          <EditMap
